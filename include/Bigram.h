...
public:
     ...
     */
    Bigram(const char first, const char second);
    ...
    /**
     * @brief It edit the text of this bigram
     * 
     * @param newText is the string that will replace the bigram text
     */
...
/*
 *@brief Gets the number of the position in the string of the @p carac character.
 * @param char character to find;
 * @param array is the string.
 * @return the position in the string of the character. (-1 in case the character doesn't appear).
 */

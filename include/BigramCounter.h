...
public:
     ...
     */
    bool setFrequency(const Bigram &bigram, const int &frequency);
     ...
     * Input parameter
     */
    void increaseFrequency(const Bigram &bigram, const int &frequency = 0);
...
private:
    ...
    /**
     * @brief Reserves the _validCharacters amount of memory entered
     */
    void asignarM();
};
